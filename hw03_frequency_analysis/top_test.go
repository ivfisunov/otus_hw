...
func TestTop10(t *testing.T) {
	...
	t.Run("positive test 2", func(t *testing.T) {
		expected := []string{"работа", "учеба", "еда", "отдых", "спорт", "мозг", "комп", "космос", "мак", "пс"}
		require.ElementsMatch(t, expected, Top10(text2))
	})

	t.Run("one letter test", func(t *testing.T) {
		expected := []string{"X"}
		require.ElementsMatch(t, expected, Top10(text3))
	})

	t.Run("empty string", func(t *testing.T) {
		require.Len(t, Top10(text4), 0)
	})
}
